...
export default function Home() {
	return (
		<main className="relative flex h-screen w-screen flex-col items-center justify-center bg-[#1A3A9E]">
			...
			<Link
				href="/register"
				className="z-20 rounded-md text-center font-bttf text-xl md:text-2xl 2xl:text-3xl bg-white flex justify-center items-center"
				target="_blank"
			>
				<h1 className="bg-gradient-to-b from-orange-600 via-yellow-300 to-orange-600 bg-clip-text p-2  font-bttf text-5xl text-transparent sm:text-7xl lg:text-8xl">
